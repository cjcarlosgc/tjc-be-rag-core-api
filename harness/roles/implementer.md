...
Implementa únicamente el plan y las tareas aprobadas dentro de `app/`, después de una puerta de decisiones válida. Mantiene contratos, pruebas y convenciones.
