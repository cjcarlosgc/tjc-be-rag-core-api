 ...
 * 3. Project de organización con registro Maintainer/Reader suficiente Y binding no
 *    `REVOKED`: la regla se evalúa en cada petición, sin depender de que el paso a
 *    `REVOKED` haya borrado registros (eso lo hace el corte 5b).
 */
