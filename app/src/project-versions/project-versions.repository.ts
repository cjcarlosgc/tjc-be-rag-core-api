...
export class ProjectVersionsRepository {
   ...
   */
  findByIdForOwner(id: string, userId: string): Promise<ProjectVersion | null> {
    return this.prisma.projectVersion.findFirst({ where: { id, project: accessibleProject(userId) } });
  }
