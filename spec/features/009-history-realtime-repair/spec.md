...
- HU24 (reintento manual) no depende de un mecanismo automático previo: permite volver a ejecutar desde cero, a pedido explícito del usuario, una generación que quedó `INVALID`/`FAILED`.
