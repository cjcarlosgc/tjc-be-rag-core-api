...
- La integración usa el contrato asíncrono Core↔Sandbox `INTEROP-2.0`. Core genera una `EphemeralDownloadRef` de vida corta para el snapshot y los artefactos necesarios; el Sandbox devuelve hechos y Core calcula la clasificación y persiste el resultado del producto.
