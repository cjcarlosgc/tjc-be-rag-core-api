...
4. Orden de login: la Console con login solo GitHub se publica antes de que Core exija identidad GitHub (el bundle A espera a esa publicación); el proveedor de correo y contraseña de Supabase Auth se deshabilita cuando la Console ya no lo ofrece, nunca antes.
