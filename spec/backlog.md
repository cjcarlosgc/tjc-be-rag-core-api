...
HU55 — aprobada para implementación el 2026-09-21 por el usuario, dentro de `T-003-org-workspaces`: `GET /analysis-runs` sin `projectId` (Runs de los Projects personales del usuario más los de organización con acceso, INTEROP-2.4 §6.10 y §6.13). Deja de estar `PROPOSED`.
