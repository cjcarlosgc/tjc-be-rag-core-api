...
**Pendiente antes de aprobar (verificaciones técnicas contra GitHub):**
...
- ¿Qué eventos cubren cada vía de acceso (colaborador directo, equipo, permiso base de la organización, cambio de rol, transferencia o renombre de repositorio) y cuáles no? Lo que un evento no cubra queda a cargo de la reconciliación horaria.
- Los códigos de error nuevos (repositorio fuera de la organización, repositorio ajeno en el workspace personal y permiso insuficiente para vincular) se nombran al consolidar el contrato en INTEROP.
