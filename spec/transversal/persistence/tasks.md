...
- [ ] Definir y migrar el índice vectorial definitivo (`DEC-EMB-001` ya `APROBADO`: `text-embedding-3-small`, 1536); el HNSW provisional fue retirado por la última migración actual.
