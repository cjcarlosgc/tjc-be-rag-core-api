...
- Para una ejecución, Core genera mediante `ObjectStorageService` una URL firmada temporal conforme a `EphemeralDownloadRef` de `INTEROP-1.5`, acompañada de SHA-256 y tamaño verificables. La vigencia solo debe permitir iniciar la descarga.
