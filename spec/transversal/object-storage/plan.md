...
Al construir una solicitud `INTEROP-1.1`, Core obtiene la `snapshotKey`, genera una URL firmada de vida corta y adjunta integridad/tamaño. La URL vive solo en tránsito, debe redactarse en observabilidad y nunca se almacena. Los resultados estructurados que retorna Sandbox ingresan otra vez por Core antes de PostgreSQL.
